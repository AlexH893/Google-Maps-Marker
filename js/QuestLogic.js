 ...
 * Author: Alex Haefner
 * Date: 4 Sep 2021
 * Description: Contains the quest logic. If a user selects a value from a dropdown, another field
 * will populate with relevant information to the initially selected value.
*/
