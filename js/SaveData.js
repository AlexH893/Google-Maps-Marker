 ...
 * Author: Alex Haefner
 * Date: 4 Sep 2021
 * Description: Handles displaying data to the information box that a user selects. If a user submits
 * a selection the window will populate the pre-defined data that corresponds to the user submitted value.
*/
